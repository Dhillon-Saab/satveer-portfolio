    ...
    <section className="pt-10 py-10 bg-neutral-50">
      <div className="flex flex-col container mx-auto text-gray-700 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-64 text-left">
        ...
        <div className="flex justify-center align-middle items-center mt-6 sm:mt-8">
          <Link
            href="/contactUs"
            className="inline-block rounded font-Josefin-Sans bg-navbar-bg px-8 sm:px-12 py-2 sm:py-3 text-sm sm:text-lg font-medium text-white transition hover:bg-slate-600 focus:outline-none focus:ring focus:ring-yellow-400"
          >
            Get In Touch
          </Link>
        </div>
