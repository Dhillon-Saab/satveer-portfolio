  ...
  return (
    <section className="overflow-hidden rounded-lg mt-5 shadow-2xl md:grid md:grid-cols-2">
      <div className="p-4 text-center sm:p-6 md:col-span-2 lg:p-8">
        <p className="text-4xl font-semibold uppercase tracking-widest font-Josefin-Sans">
          Companies that trust Us.
        </p>

        <div className="flex gap-4 mt-10">
          <span className="text-lg justify-center items-center mx-auto  font-black sm:text-sm lg:text-sm">
            <Image src={"/Grid.png"} alt="our trusted ones" height={1000} width={1000} className="w-full h-full"/>
          </span>
        </div>
      </div>
    </section>
